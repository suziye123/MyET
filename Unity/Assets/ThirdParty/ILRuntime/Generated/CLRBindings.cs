...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            System_Collections_Generic_Dictionary_2_UInt16_ILTypeInstance_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_UInt16_ILTypeInstance_Binding.Register(app);
            System_IDisposable_Binding.Register(app);
            System_Int64_Binding.Register(app);
            UnityEngine_UI_Text_Binding.Register(app);
            UnityEngine_Component_Binding.Register(app);
            ReferenceCollectorEx_Binding.Register(app);
            ...
            ETModel_RoomConfig_Binding.Register(app);
            ...
            ETModel_UIPanelConfig_Binding.Register(app);
