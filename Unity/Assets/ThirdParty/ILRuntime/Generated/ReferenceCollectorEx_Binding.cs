...
{
    unsafe class ReferenceCollectorEx_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(ReferenceCollectorEx);
        ...
        static StackObject* GetComponent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ReferenceCollector @rc = (ReferenceCollector)typeof(ReferenceCollector).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = ReferenceCollectorEx.GetComponent<UnityEngine.UI.Image>(@rc, @ResName);
        ...
        static StackObject* GetComponent_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ReferenceCollectorEx.GetComponent<UnityEngine.UI.Text>(@rc, @ResName);
        ...
        static StackObject* GetComponent_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ReferenceCollectorEx.GetComponent<UnityEngine.UI.Button>(@rc, @ResName);
        ...
        static StackObject* GetComponent_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ReferenceCollectorEx.GetComponent<UnityEngine.UI.InputField>(@rc, @ResName);
